...
const indexData = async () => {
  try {
    ...
    // Cria o índice com mapeamento para diferentes tipos de documentos
      ...
      body: {
        mappings: {
          properties: {
            ...
            other_content_field: { type: "text" }, // Campo para outros tipos de conteúdo futuros
          },
        },
      },
    });
    ...
    const bulkInsert = async (data) => {
      const body = data.flatMap((doc) => [
        ...
        { ...doc, type: "book" }, // Adiciona o tipo "book" aos documentos
      ]);
      try {
